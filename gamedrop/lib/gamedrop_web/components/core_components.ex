defmodule GamedropWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GamedropWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GamedropWeb.Gettext, "errors", msg, opts)
    end
  end
