defmodule GamegiftingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GamegiftingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GamegiftingWeb.Gettext, "errors", msg, opts)
    end
  end
