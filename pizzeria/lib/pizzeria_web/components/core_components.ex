defmodule PizzeriaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PizzeriaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PizzeriaWeb.Gettext, "errors", msg, opts)
    end
  end
